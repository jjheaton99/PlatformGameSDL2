...
class PlayerMeleeAttack : public GameObject
{
protected:
    ItemType m_itemType;
...
public:
    PlayerMeleeAttack(std::string fileName, int damage, double xBasePos, double yBasePos, double colliderWidth, double colliderHeight, double attackDuration = 0);
    virtual ~PlayerMeleeAttack();
