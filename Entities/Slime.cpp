...
Slime::Slime(double xStartPos, double yStartPos, double xVel, double yVel, std::string fileName, double colliderWidth, double colliderHeight, int hitPoints, int spriteSheetCount, int damage)
